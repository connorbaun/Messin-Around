...
public class PlayerShoot2 : MonoBehaviour {
    ...
    public void Start()
    {
        ...
        //ammo2 = GetComponentInChildren<AmmoManager2>();
    ...
    public void Update()
    {
        ...
        if (Input.GetButtonDown("2Fire2")) //if the player pushes whatever button we labeled as "FIRE1" in the Input Manager...
        {
    ...
    public void AmmoHandler()
    {
        if (currentClipAmmo < maxClipAmmo && currentPocketAmmo > 0)
        {
                ...
                if (Input.GetButtonDown("2Reload"))
                {
    ...
    public void MeleeHandler()
    {
        ...
        {
            if (Input.GetButtonDown("2Melee") && !anim.GetCurrentAnimatorStateInfo(0).IsName("Reloading")) //if at anypoint we push melee
            {
